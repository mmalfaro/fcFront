            ...
            <div class="container">
                <div class="col l12 center">
                    <div class="banner-icono">
                        <img src="img/icono-programacion.png" class="responsive-img" alt="">
                        <h3>PROGRAMACIÓN</h3>
                        <p class="subtitulo-banner">Desarrolla programas y apps con los métodos y las tecnologías más actuales</p>
                    </div>
                </div>
            </div>
        </section>

        <section class="curso-todo">
            <div class="container">
                <div class="row">
                    <div class="col l12 s12 m12 center-align">
                        <h2>Cursos especializados para programación</h2>
                    </div>
